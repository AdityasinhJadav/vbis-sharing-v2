...
const AuthLogin = () => {
  ...
  // Google Login removed for now as it requires backend implementation
  const handleGoogleLogin = () => {
    setError('Google Login not yet implemented with new backend');
  };
          ...
          >
            ...
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <Motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="button"
                className={`w-full flex items-center justify-center py-4 px-6 rounded-xl font-medium transition-all duration-300 backdrop-blur-sm ${isLight
